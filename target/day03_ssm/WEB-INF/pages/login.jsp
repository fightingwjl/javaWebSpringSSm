                        ...
                        <div class="wrapper">
                            ...
                            <div id="contact_form">
                                ...
                                <form action="login" method="post">
                                    ...
                                    <label for="author">账号:</label> <input type="text" id="author" name=Sno class="required input_field" />
                                    <div class="cleaner_h10"></div>

                                    <label for="email">密码:</label> <input type="text" id="email" name="password" class="validate-email required input_field" />
                                    <div class="cleaner_h10"></div>
