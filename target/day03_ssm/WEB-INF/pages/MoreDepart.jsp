...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
        ...
        <div class="section_w670">
            ...
            <h2>Department Message</h2>
            <div class="div-a">部门号：<br/>
                <c:forEach   items="${MDepart}" var="listMoreDepart">
                    ${listMoreDepart.dno} <br/>
                </c:forEach>
            </div>
            <div class="div-a">部门名称：<br/>
                <c:forEach   items="${MDepart}" var="listMoreDepart">
                    ${listMoreDepart.dname} <br/>
                </c:forEach>
            </div>
            <div class="div-a">经理名称：<br/>
                <c:forEach   items="${MDepart}" var="listMoreDepart">
                    ${listMoreDepart.sname} <br/>
                </c:forEach>
            </div>
            <div class="div-a">工号：<br/>
                <c:forEach   items="${MDepart}" var="listMoreDepart">
                    ${listMoreDepart.sno} <br/>
                </c:forEach>
            </div>
            <div class="div-d">
                <br/><br/><br/>
